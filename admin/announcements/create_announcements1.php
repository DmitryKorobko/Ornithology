...
if ($action =="insert"){
	...
	//insert new article
	$sqlsel="INSERT INTO $main ".ANNOUNCEMENT_MAIN_FIELDS." VALUES (";
	...
	$sqlsel="INSERT INTO $status ".ANNOUNCEMENT_STATUS_FIELDS." VALUES (";
	...
	$new_article_id = mysql_insert_id();
	if ($result){
	header("Location: pick_announcements.php?article=$new_article_id&mode=EDIT"); /* Redirect browser */
	}
}
...
<body>
<p class="major_title">Creating Announcement....</p>
...
<table border="0" cellspacing="1" cellpadding="0">
  ...
  <tr>
    ...
    <td align="right">&nbsp;</td>
    <td><input type="text" name="created" size="30" maxlength="30" value=""> Set to today's date <input type="checkbox" name="checkbox" value="checkbox" onClick="validateText(news)"></td>
  </tr>
  <tr>
