...
switch ($action) {
	...
	$sqlsel="INSERT INTO $text ".ANNOUNCEMENT_TEXT_FIELDS." VALUES (";
	$sqlsel.="'".$article_id."', ";
...
<td><font face="Verdana,Arial" size="1"><?php echo auto_link($row["text"]); ?></font></td>
</tr>
<?php
}
?>
</table>
<p><center><a href="javascript:window.close();" onMouseOver="window.status='Close this window and continue';return true" onMouseOut="window.status='';return true"><img src="../images/continue_button.gif" width="163" height="24" border="0"></a>&nbsp;&nbsp;<a href="add_row_announcements1.php?article=<?php echo $article_id; ?>&dbtable=<?php echo $text; ?>&random=1114440742" onMouseOver="window.status='Add another record';return true" onMouseOut="window.status='';return true"><img src="../images/add_another.gif" width="163" height="24" border="0"></a></center></p>
</body>
</html>
