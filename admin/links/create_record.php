...
$family_links = "links_family_links";
$species_links = "links_species_links";
$sublinks = "sublinks";
...
<body>
<p align="center" class="footer"><a href="#introduction">Introduction</a> | <a href="#sublinks">Sub Links</a> | <a
        href="#top_sites">Top Sites</a> | <a href="#useful_reading">Useful Reading</a> | <a href="#useful_information">Useful
        Information</a> | <a href="#county_recorder">County Recorder</a> | <a href="#contributor">Contributor</a> | <a
        href="#links" style="text-decoration:none">Links</a> | <a href="#places_to_stay" style="text-decoration:none">Places
        to stay</a></p>

<p class="major_title"><?PHP echo $subcategory; ?></p>

<p class="title"><a name="photo">Photo</a></p>
...
<p>
    ...
    if ($count > 0) {
        while ($row = mysql_fetch_assoc($result)) {
            ?>
            <img src="<?php echo ROOT_URL; ?>/photos/<?php echo $row["filename"]; ?>"
                 width="<?php echo $row["width"]; ?>" height="<?php echo $row["height"]; ?>" border="0"><br>
            <font face="verdana" size="1" color="#808080"><?php echo auto_link(htmlentities($row["text"])); ?></font>
            <br>
            <a href="javascript:popDeletePhoto('<?php echo $row["id"]; ?>','<?php echo $photo; ?>','<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
        ...
        ?>
        <a href="javascript:popAddPhoto('<?php echo $category; ?>','<?php echo $photo; ?>','<?php echo $subcategory; ?>','1115204618','<?php echo $_SERVER['PHP_SELF']; ?>');"
           onMouseOver="window.status='Add a new photo to this page';return true"
           onMouseOut="window.status='';return true"><font color="#FF0000">[add a photo]</font></a>
...
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $intro WHERE `page_id` = '$pageId' ORDER BY paragraph";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
if ($count > 0) {
    while ($row = mysql_fetch_assoc($result)) {
        ...
        <p><b>Paragraph:</b> <?php echo $row["paragraph"]; ?><br>
            ...
            <a href="javascript:popAddRow('<?php echo $intro; ?>','<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
            ...
            <a href="javascript:popUpdateRow('<?php echo $intro; ?>',<?php echo $row["id"]; ?>,'<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
            ...
            <a href="javascript:popDeleteRow('<?php echo $intro; ?>',<?php echo $row["id"]; ?>,'<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
               onMouseOver="window.status='Remove this record from this page';return true"
               onMouseOut="window.status='';return true"><font color="#FF0000">[delete]</font></a>&nbsp;&nbsp;
            <font color="#646464">
...
?>
<hr size="1">
<p class="title"><a name="sublinks">Sub Links</a></p>
<?php
//echo $category;
//echo $subcategory;

$select = "SELECT * FROM $sublinks WHERE `page_id` = '$pageId'";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
if ($count > 0) {
    while ($row = mysql_fetch_assoc($result)) {
        echo "<p>" . html_entity_decode($row["sublinks"]) . "</p>";

        ?>
        <p>
            <a href="javascript:popAddRow('<?php echo $sublinks; ?>','<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
               onMouseOver="window.status='Add a new record to this page';return true"
               onMouseOut="window.status='';return true"><font color="#FF0000">[add]</font></a>&nbsp;&nbsp;
            <a href="javascript:popUpdateRow('<?php echo $sublinks; ?>',<?php echo $row["id"]; ?>,'<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
               onMouseOver="window.status='Update this record';return true"
               onMouseOut="window.status='';return true"><font color="#FF0000">[update]</font></a>&nbsp;&nbsp;
            <a href="javascript:popDeleteRow('<?php echo $sublinks; ?>',<?php echo $row["id"]; ?>,'<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
               onMouseOver="window.status='Remove this record from this page';return true"
               onMouseOut="window.status='';return true"><font color="#FF0000">[delete]</font></a>&nbsp;&nbsp;
        </p>
    <?php
...
<p>
    <?php
    $select = "SELECT * FROM $banners WHERE `page_id` = '$pageId'ORDER BY id";
    //echo $select;
    $result = mysql_query($select);
    $count = mysql_num_rows($result);
    ...
    {
    ?>
    <img src="<?php echo ROOT_URL; ?>/adverts/<?php echo $row["filename"]; ?>" width="<?php echo $row["width"]; ?>"
         height="<?php echo $row["height"]; ?>" border="0"><br>
    <font face="verdana" size="1" color="#808080"><?php echo auto_link(htmlentities($row["url"])); ?></font><br>
    <font face="verdana" size="1" color="#808080"><?php echo auto_link(htmlentities($row["sponsor"])); ?></font><br>
    <font face="verdana" size="1" color="#808080"><?php echo auto_link(htmlentities($row["text"])); ?></font><br>
    <a href="javascript:popDeleteBanner('<?php echo $row["id"]; ?>','<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
       onMouseOver="window.status='Remove this record from this page';return true"
       onMouseOut="window.status='';return true"><font color="#FF0000">[delete]</font></a></p>
<?php
}
...
if ($count < 2) {
    ?>
    <a href="javascript:popAddBanner('<?php echo $category; ?>','<?php echo $subcategory; ?>','1115289169','<?php echo $_SERVER['PHP_SELF']; ?>');"
       onMouseOver="window.status='Add a new record to this page';return true"
       onMouseOut="window.status='';return true"><font color="#FF0000">[add a banner]</font></a>
    <small> - invisible</small></p>
<?php
}
...
<hr size="1">
<?php
if ($category == "ornithology") {
    switch ($subcategory) {
        case "banding_and_ringing":
        case "bird_fairs":
        case "birding_organisations":
        case "conservation":
        case "courses":
        case "identification":
        case "migration":
        case "museums":
        case "names_and_taxonomy":
        case "pelagics":
        case "study_and_behaviour":
        case "weather_and_tides":
            break;
        default:
            ?>
                <p class="title"><a name="family_links">Family Link</a></p>
            <?php

            $select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $family_links WHERE `category` = '$category' AND `sub-category` = '$subcategory' ORDER BY title";
            //echo $select;
            $result = mysql_query($select);
            $count = mysql_num_rows($result);
            ...
            if ($count > 0) {
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <p><b><?php echo auto_link($row["title"]); ?></b><br>
                        ...
                        <a href="javascript:popAddRow('<?php echo $family_links; ?>','<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
                           onMouseOver="window.status='Add a new record to this page';return true"
                           onMouseOut="window.status='';return true"><font color="#FF0000">[add]</font></a>&nbsp;&nbsp;
                        <a href="javascript:popUpdateRow('<?php echo $family_links; ?>',<?php echo $row["id"]; ?>,'<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
                           onMouseOver="window.status='Update this record';return true"
                           onMouseOut="window.status='';return true"><font color="#FF0000">[update]</font></a>&nbsp;&nbsp;
                        <a href="javascript:popDeleteRow('<?php echo $family_links; ?>',<?php echo $row["id"]; ?>,'<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
                           onMouseOver="window.status='Remove this record from this page';return true"
                           onMouseOut="window.status='';return true"><font color="#FF0000">[delete]</font></a>&nbsp;&nbsp;
                        <font color="#646464">
                            <small><?php echo auto_link($row["timestamp"]); ?></small>
            ...
            ?>
                <hr size="1">
                <p class="title"><a name="species_links">Species Link</a></p>
            <?php
            //echo $category;
            //echo $subcategory;
            $select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $species_links WHERE `page_id` = '$pageId' ORDER BY title";
            //echo $select;
            $result = mysql_query($select);
            $count = mysql_num_rows($result);
            ...
            if ($count > 0) {
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <p><b><?php echo auto_link($row["title"]); ?></b><br>
                        <?php echo auto_link($row["url"]); ?><br>
                        <?php echo auto_link($row["link_desc"]); ?><br>
                        <a href="javascript:popAddRow('<?php echo $species_links; ?>','<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
                           onMouseOver="window.status='Add a new record to this page';return true"
                           onMouseOut="window.status='';return true"><font color="#FF0000">[add]</font></a>&nbsp;&nbsp;
                        <a href="javascript:popUpdateRow('<?php echo $species_links; ?>',<?php echo $row["id"]; ?>,'<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
                           onMouseOver="window.status='Update this record';return true"
                           onMouseOut="window.status='';return true"><font color="#FF0000">[update]</font></a>&nbsp;&nbsp;
                        <a href="javascript:popDeleteRow('<?php echo $species_links; ?>',<?php echo $row["id"]; ?>,'<?php echo $category; ?>','<?php echo $subcategory; ?>','1114526428','<?php echo $_SERVER['PHP_SELF']; ?>');"
                           onMouseOver="window.status='Remove this record from this page';return true"
                           onMouseOut="window.status='';return true"><font color="#FF0000">[delete]</font></a>&nbsp;&nbsp;
                        <font color="#646464">
                            <small><?php echo auto_link($row["timestamp"]); ?></small>
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $topsites WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
if ($count > 0) {
    while ($row = mysql_fetch_assoc($result)) {
        ...
        <p><b> <?php echo auto_link($row["title"]); ?> </b>
            <?php if ($row["grid_reference"]) { ?>
                (
                <a href="javascript:popupMap('<?php echo $row["grid_reference"]; ?>')"><?php echo $row["grid_reference"]; ?>
                    - click to test map</a>).
            <?php } ?>
            <?php echo auto_link($row["text"]); ?><br>
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $contributor WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $county WHERE `page_id` = '$pageId' ORDER BY name";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
if ($count > 0) {
    while ($row = mysql_fetch_assoc($result)) {
        ?>
        <p>
            <?php echo auto_link($row["name"]); ?><br>
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $species WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $endemics WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $useful WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $useful_info WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $organisations WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $festivals WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $observatories WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $museums WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $reserves WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $trips WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $holiday WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $places WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $mailing WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $links WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
if ($count > 0) {
    while ($row = mysql_fetch_assoc($result)) {
        ...
        <p><b><?php echo auto_link($row["title"]); ?></b><br>
            <?php echo auto_link($row["url"]); ?><br>
            <?php
            //$text = htmlentities($row["link_desc"]);

            echo auto_link(htmlentities($row["link_desc"]));
            ?><br>
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $artists WHERE `page_id` = '$pageId' ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
