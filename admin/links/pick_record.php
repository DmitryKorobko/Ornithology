...
?>
<hr size="1">
<p class="title">Bird Families</p>
<?php
$family = new DisplayBirdFamily("", $category, $subcategory);
echo $family->getDisplaySite();
echo $family->getGotoAdmin();
?>
<hr size="1">
...
//echo $category;
//echo $subcategory;
$select = "SELECT * FROM $sublinks WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory')";
//echo $select;
$result = mysql_query($select);
...
if ($category == "ornithology") {
    switch ($subcategory) {
        ...
        default:
            ...
            <?php
            $select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $family_links WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
            //echo $select;
            $result = mysql_query($select);
            $count = mysql_num_rows($result);
            ...
            //echo $category;
            //echo $subcategory;
            $select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $species_links WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
            //echo $select;
            $result = mysql_query($select);
            $count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $topsites WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $contributor WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $county WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY `name`";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $species WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $endemics WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<hr size="1">
<p class="title"><a name="checklist">Checklist</a></p>
<?php
$check = new DisplayChecklist("", $category, $subcategory);
echo $check->getDisplaySite();
echo $check->getAdminOptions();
?>
<hr size="1">
<p class="title"><a name="useful_reading">Useful Reading</a></p>
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $useful WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $useful_info WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $organisations WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $festivals WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $observatories WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $museums WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $reserves WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $trips WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $holiday WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $places WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $mailing WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $links WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
<?php
$select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $artists WHERE `page_id` = (SELECT `page_id` FROM `pagename` WHERE `category` = '$category' AND `sub-category` = '$subcategory') ORDER BY title";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
