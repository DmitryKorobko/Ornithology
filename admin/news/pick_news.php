...
function popAddRow(js_dbtable,js_article,js_random) {
	popupdate = window.open('add_row_news1.php?dbtable=' + js_dbtable + '&article=' + js_article + '&random=' + js_random,'popupdate','width=590,height=350,left=50,top=50,status=yes,scrollbars=yes');
}

function popUpdateRow(js_dbtable,js_article,js_id,js_random) {
	popupdate = window.open('add_row_news1.php?mode=EDIT&id=' + js_id + '&dbtable=' + js_dbtable + '&article=' + js_article + '&random=' + js_random,'popupdate','width=590,height=350,left=50,top=50,status=yes,scrollbars=yes');
}

function popDeleteRow(js_dbtable,js_article,js_id,js_random) {
	popupdate = window.open('add_row_news1.php?mode=DELETE&id=' + js_id + '&dbtable=' + js_dbtable + '&article=' + js_article + '&random=' + js_random,'popupdate','width=590,height=350,left=50,top=50,status=yes,scrollbars=yes');
}

function popAddImage(js_dbtable,js_article,js_random) {
	popupdate = window.open('add_image_news1.php?dbtable=' + js_dbtable + '&article=' + js_article + '&random=' + js_random,'popupdate','width=590,height=425,left=50,top=50,status=yes,scrollbars=yes');
}

function popDeleteImage(js_dbtable,js_article,js_random) {
	popupdate = window.open('add_image_news1.php?dbtable=' + js_dbtable + '&article=' + js_article + '&random=' + js_random + '&action=delete','popupdate','width=590,height=425,left=50,top=50,status=yes,scrollbars=yes');
}
...
<tr>
	...
	<img src="<?php echo "../../images_news/".$row["image"]; ?>" border="0" alt="Click here to replace this image with another"></a><br>
