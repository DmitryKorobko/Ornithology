...
if ($action){
	switch ($action) {
		...
		$sqlsel="SELECT * FROM $info_type WHERE `category`='".$category."' AND `sub-category`='".$subcategory."'";
		//echo $sqlsel;
...
<table cellpadding="3">
    <tr>
        ...
        <td><font face="ms sans serif" size="3"><textarea cols="53" rows="9" name="sublinks"></textarea></font></td>
    </tr>
    <tr>
...
<table cellpadding="3">
    ...
    <tr>
        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
        <td><font face="ms sans serif" size="3"><textarea cols="58" rows="9" name="link_desc"></textarea></font></td>
    </tr>
    <tr>
<td colspan="2"align="right"><a href="javascript:document.add_row.submit()" onMouseOver="window.status='Add this new record to the current page';return true" onMouseOut="window.status='';return true"><img src="../images/submit_changes_button.gif" width="126" height="24" border="0"></a>&nbsp;&nbsp;<a href="javascript:window.close()" onMouseOver="window.status='Abandon your changes and close this window';return true" onMouseOut="window.status='';return true"><img src="../images/abandon_changes_button.gif" width="163" height="24" border="0"></a></td>
    </tr>
		...
		<form name="add_row" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=links2" method="post">
			...
			<table cellpadding="3">
				...
				<tr>
					<td><font face="Verdana,Arial" size="2"><b>URL : </b></font></td>
					<td><font face="ms sans serif" size="3">
						<input type="text" size="67" name="url1">
						</font></td>
				</tr>
				<tr>
...
<table cellpadding="3">
    ...
    <tr>
        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
        <td><font face="ms sans serif" size="3"><textarea cols="52" rows="10" name="text"></textarea></font></td>
    </tr>
    <tr>
<td colspan="2"align="right"><a href="javascript:document.add_row.submit()" onMouseOver="window.status='Add this new record to the current page';return true" onMouseOut="window.status='';return true"><img src="../images/submit_changes_button.gif" width="126" height="24" border="0"></a>&nbsp;&nbsp;<a href="javascript:window.close()" onMouseOver="window.status='Abandon your changes and close this window';return true" onMouseOut="window.status='';return true"><img src="../images/abandon_changes_button.gif" width="163" height="24" border="0"></a></td>
    </tr>
...
<input type="hidden" name="ref_url" value="<?php echo $ref_url; ?>">
  <table cellpadding="3">
    <tr>
      ...
      <td><font face="Verdana,Arial" size="2"><b>URL : </b></font></td>
      <td><font face="ms sans serif" size="3"><input type="text" size="24" name="url"></font></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><font face="ms sans serif" size="3"><input type="text" size="24" name="body_message"></font></td>
    </tr>
    <tr>
      <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
      <td colspan="3"><font face="ms sans serif" size="3"><textarea cols="54" rows="5" name="text"></textarea></font></td>
    </tr>
    <tr>
...
<table cellpadding="3">
    ...
    <tr>
        ...
        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="grid_reference"></font></td>
    </tr>
    <tr>
        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
        <td><font face="ms sans serif" size="3"><textarea cols="55" rows="8" name="text"></textarea></font></td>
    </tr>
    <tr>
        <td colspan="2"align="right"><a href="javascript:document.add_row.submit()" onMouseOver="window.status='Add this new record to the current page';return true" onMouseOut="window.status='';return true"><img src="../images/submit_changes_button.gif" width="126" height="24" border="0"></a>&nbsp;&nbsp;<a href="javascript:window.close()" onMouseOver="window.status='Abandon your changes and close this window';return true" onMouseOut="window.status='';return true"><img src="../images/abandon_changes_button.gif" width="163" height="24" border="0"></a></td>
    </tr>
...
<table cellpadding="3">
   <tr>
    ...
    <tr>
        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text : </b></font></td>
        <td><font face="ms sans serif" size="3"><textarea cols="45" rows="8" name="text"></textarea></font></td>
    </tr>
    <tr>
...
<table cellpadding="3">
   <tr>
    ...
    <tr>
        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
        <td><font face="ms sans serif" size="3"><textarea cols="58" rows="10" name="text"></textarea></font></td>
    </tr>
    <tr>
        <td colspan="2"align="right"><a href="javascript:document.add_row.submit()" onMouseOver="window.status='Add this new record to the current page';return true" onMouseOut="window.status='';return true"><img src="../images/submit_changes_button.gif" width="126" height="24" border="0"></a>&nbsp;&nbsp;<a href="javascript:window.close()" onMouseOver="window.status='Abandon your changes and close this window';return true" onMouseOut="window.status='';return true"><img src="../images/abandon_changes_button.gif" width="163" height="24" border="0"></a></td>
    </tr>
