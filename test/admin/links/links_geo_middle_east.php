    ...
    <script language="JavaScript">
        ...
        function load(object) {
            if (object.options[object.selectedIndex].value == 'Select a Region') {
                ...
                parent.home.location.href = 'pick_record_geo.php?category=middle_east&subcategory=' + object.options[object.selectedIndex].value + '&random=1115133085' + rand(255);
                return false;
            }
        }

        function quickload(place) {
            parent.home.location.href = 'pick_record_geo.php?category=middle_east&subcategory=' + place + '&random=1115133085' + rand(255);
        }
        ...
        function showlinks() {
            ...
            if (subcategory == 'Israel') {
                opt('', 'No further response required');
                quickload('israel');
            }
            if (subcategory == 'Jordan') {
                opt('', 'No further response required');
                quickload('jordan');
            }
            if (subcategory == 'Kuwait') {
                opt('', 'No further response required');
                quickload('kuwait');
            }
            if (subcategory == 'Lebanon') {
                opt('', 'No further response required');
                quickload('lebanon');
            }
            if (subcategory == 'Oman') {
            ...
            if (subcategory == 'Palestine') {
                opt('', 'No further response required');
                quickload('palestine');
            }
            if (subcategory == 'Qatar') {
                opt('', 'No further response required');
                quickload('qatar');
            }
            if (subcategory == 'Saudi Arabia') {
                opt('', 'No further response required');
                quickload('saudi_arabia');
            }
            if (subcategory == 'Syria') {
                opt('', 'No further response required');
                quickload('syria');
            }
            if (subcategory == 'UAE') {
            ...
            if (subcategory == 'Yemen') {
                opt('', 'No further response required');
                quickload('yemen');
            }
            if (subcategory == 'General Middle East') {
                opt('', 'No further response required');
                quickload('middle_east');
            }
...
<table border="0" cellpadding="0" cellspacing="5">
    <tr>
        <td valign="top"><font face="Verdana,Arial" size="4">&nbsp;Middle East ></font></td>
        <td>
            <form name="category">
