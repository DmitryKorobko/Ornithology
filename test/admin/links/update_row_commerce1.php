...
if ($action) {
    switch ($action) {
        case "intro":
            ...
            $sqlsel .= "text = '" . encode(convertForInput($_POST['text'])) . "'";
            break;
...
switch ($mode) {
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="title"
                                                                       value="<?php echo $row["title"]; ?>"></font></td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>URL : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="url1"
                                                                       value="<?php echo $row["url1"]; ?>"></font></td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>URL Title: </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="url1_title"
                                                                       value="<?php echo $row["url1_title"]; ?>"></font>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
                        <td><font face="ms sans serif" size="3"><textarea cols="58" rows="9"
                                                                          name="link_desc"><?php echo $row["link_desc"]; ?></textarea></font>
                        </td>
                    </tr>
                <?php
                }
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3">
                                <input type="text" size="67" name="url2_title"
                                       value="<?php echo $row["url2_title"]; ?>">
                            </font></td>
                    </tr>
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><input type="text" size="60" name="title"
                                                                       value="<?php echo $row["title"]; ?>"></font></td>
                    </tr>
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
                        <td><font face="ms sans serif" size="3"><textarea cols="52" rows="10"
                                                                          name="text"><?php echo $row["text"]; ?></textarea></font>
                        </td>
                    </tr>
                <?php
                }
    ...
    case "INTRO":
        ...
        <body>
        <p><font face="Verdana,Arial" size="5">Update record</font></p>
        <?php
        $introduction = new Introdisplay("", $category, $subcategory);
        echo $introduction->getDisplayAdmin();
        ?>
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><input type="text" size="63" name="name"
                                                                       value="<?php echo $row["name"]; ?>"></font></td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Title : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="title"
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="location"
                                                                       value="<?php echo $row["location"]; ?>"></font>
                        </td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Email : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="email"
                                                                       value="<?php echo $row["email"]; ?>"></font></td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>URL : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="url1"
        ...
        <form name="add_row" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=recorder" method="post">
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Name : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="64" name="name"
                                                                       value="<?php echo $row["name"]; ?>"></font></td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Address : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="64" name="address"
                                                                       value="<?php echo $row["address"]; ?>"></font>
                        </td>
                    </tr>
                    <tr>
                        <td nowrap><font face="Verdana,Arial" size="2"><b>Telephone: </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="64" name="telephone"
                                                                       value="<?php echo $row["telephone"]; ?>"></font>
                        </td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Fax : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="64" name="fax"
                                                                       value="<?php echo $row["fax"]; ?>"></font></td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Email : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="64" name="email"
                                                                       value="<?php echo $row["email"]; ?>"></font></td>
                    </tr>
                <?php
                }
        ...
        <form name="add_row" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=mailing" method="post">
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Title : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="24" name="title"
                                                                       value="<?php echo $row["title"]; ?>"></font></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>URL : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="24" name="url1"
                                                                       value="<?php echo $row["url1"]; ?>"></font></td>
                        <td><font face="Verdana,Arial" size="2"><b>URL Title: </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="url1_title"
                                                                       value="<?php echo $row["url1_title"]; ?>"></font>
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><input type="text" size="24" name="post_email"
                                                                       value="<?php echo $row["post_email"]; ?>"></font>
                        </td>
                        <td><font face="Verdana,Arial" size="2"><b>Contact: </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="24" name="contact"
                                                                       value="<?php echo $row["contact"]; ?>"></font>
                        </td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Subscribe : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="24" name="sub_email"
                                                                       value="<?php echo $row["sub_email"]; ?>"></font>
                        </td>
                        <td><font face="Verdana,Arial" size="2"><b>Unsubscribe : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="24" name="unsub_email"
                                                                       value="<?php echo $row["unsub_email"]; ?>"></font>
                        </td>
                    </tr>
                    <tr>
                        <td nowrap><font face="Verdana,Arial" size="2"><b>Subject : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="24" name="sub_message"
                                                                       value="<?php echo $row["sub_message"]; ?>"></font>
                        </td>
                        <td><font face="Verdana,Arial" size="2"><b>Body : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="24" name="body_message"
                                                                       value="<?php echo $row["body_message"]; ?>"></font>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><input type="text" size="67" name="grid_reference"
                                                                       value="<?php echo $row["grid_reference"]; ?>"></font>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
                        <td><font face="ms sans serif" size="3"><textarea cols="55" rows="8"
                                                                          name="text"><?php echo $row["text"]; ?></textarea></font>
                        </td>
                    </tr>
                <?php
        ...
        <form name="add_row" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=useful" method="post">
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Title : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="57" name="title"
                                                                       value="<?php echo $row["title"]; ?>"></font></td>
                    </tr>
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text : </b></font></td>
                        <td><font face="ms sans serif" size="3"><textarea cols="45" rows="8"
                                                                          name="text"><?php echo $row["text"]; ?></textarea></font>
                        </td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>ISBN : </b></font></td>
                        <td><font face="ms sans serif" size="3"><input type="text" size="57" name="isbn"
                                                                       value="<?php echo $row["isbn"]; ?>"></font></td>
                    </tr>
                <?php
                }
                ?>
        ...
        <form name="add_row" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=useful_info" method="post">
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
                        <td><font face="ms sans serif" size="3"><textarea cols="58" rows="10"
                                                                          name="text"><?php echo $row["text"]; ?></textarea></font>
                        </td>
                    </tr>
                <?php
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
                        <td><font face="ms sans serif" size="3"><textarea cols="58" rows="10"
                                                                          name="sublinks"><?php echo $row["sublinks"]; ?></textarea></font>
                        </td>
                    </tr>
                <?php
                }
