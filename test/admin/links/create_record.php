...
//echo $category;
//echo $subcategory;
$select = "SELECT * FROM $sublinks WHERE `category` = '$category' AND `sub-category` = '$subcategory'";
//echo $select;
$result = mysql_query($select);
$count = mysql_num_rows($result);
...
if ($category == "ornithology") {
    switch ($subcategory) {
        ...
        default:
            ...
            //echo $category;
            //echo $subcategory;
            $select = "SELECT *, date_format(timestamp, '%d/%m/%Y') as timestamp FROM $species_links WHERE `category` = '$category' AND `sub-category` = '$subcategory' ORDER BY title";
            //echo $select;
            $result = mysql_query($select);
            $count = mysql_num_rows($result);
