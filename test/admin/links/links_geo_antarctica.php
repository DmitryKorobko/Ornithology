    ...
    <script language="JavaScript">
        ...
        function load(object) {
            if (object.options[object.selectedIndex].value == 'Select a Region') {
                ...
                parent.home.location.href = 'pick_record_geo.php?category=antarctica&subcategory=' + object.options[object.selectedIndex].value + '&random=1115113191' + rand(255);
                return false;
            }
        }

        function quickload(place) {
            parent.home.location.href = 'pick_record_geo.php?category=antarctica&subcategory=' + place + '&random=1115113191' + rand(255);
        }

        function showlinks() {
            if (subcategory == 'Antarctica') {
                opt('', 'No further response required');
                quickload('antarctica');
            }
...
<table border="0" cellpadding="0" cellspacing="5">
    <tr>
        <td valign="top"><font face="Verdana,Arial" size="4">&nbsp;Antarctica ></font></td>
        <td>
            <form name="category">
