    ...
    <script language="JavaScript">
        ...
        function load(object) {
            if (object.options[object.selectedIndex].value == 'Select a sub-category') {
                ...
                parent.home.location.href = 'pick_record.php?category=trip_reports&subcategory=' + object.options[object.selectedIndex].value + '&random=1114681203' + rand(255);
                return false;
            }
        }

        function quickload(place) {
            parent.home.location.href = 'pick_record.php?category=trip_reports&subcategory=' + place + '&random=1114681203' + rand(255);
        }

        function showlinks() {
            if (subcategory == 'Trip reports links') {
...
<table border="0" cellpadding="0" cellspacing="5">
    <tr>
        <td valign="top"><font face="Verdana,Arial" size="4">&nbsp;Trip reports></font></td>
        <td>
            <form name="category">
                <select name="subcategory" onChange="return reshow(document.category.subcategory)">
                    <option selected>Select a category</option>
                    <!--<option>Trip reports links</option>-->
                    <?php
                    $category = "trip_reports";
