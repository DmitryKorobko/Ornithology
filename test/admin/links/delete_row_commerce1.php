            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><?php echo html_entity_decode($row["title"]); ?></font>
                        </td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>URL : </b></font></td>
                        <td><font face="ms sans serif" size="3"><?php echo html_entity_decode($row["url"]); ?></font>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
                        <td><font face="ms sans serif" size="3"><?php echo html_entity_decode(
                                    $row["link_desc"]
                                ); ?></font></td>
                    </tr>
                <?php
                ...
                <tr>
                    <td colspan="2" align="right"><a href="javascript:document.add_row.submit()"
                                                     onMouseOver="window.status='Delete this record from the current page';return true"
        ...
        <form name="add_row" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=delete" method="post">
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
                        <td><font face="ms sans serif" size="3"><?php echo html_entity_decode($row["text"]); ?></font>
                        </td>
                    </tr>
                <?php
                }
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><?php echo html_entity_decode($row["name"]); ?></font>
                        </td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Title : </b></font></td>
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><?php echo html_entity_decode($row["email"]); ?></font>
                        </td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>URL : </b></font></td>
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><font face="ms sans serif" size="3"><?php echo html_entity_decode($row["fax"]); ?></font>
                        </td>
                    </tr>
                    <tr>
                        <td><font face="Verdana,Arial" size="2"><b>Email : </b></font></td>
        ...
        <form name="add_row" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=delete" method="post">
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td valign="top"><font face="Verdana,Arial" size="2"><b>Text: </b></font></td>
                        <td colspan="3"><font face="ms sans serif" size="3"><?php echo html_entity_decode(
                                    $row["text"]
                                ); ?></font></td>
                    </tr>
                <?php
        ...
        <form name="add_row" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=delete" method="post">
            ...
            <table cellpadding="3">
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td nowrap><font face="Verdana,Arial" size="2"><b>Title : </b></font></td>
                        <td><font face="ms sans serif" size="3"><?php echo $row["sublinks"]; ?></font></td>
                    </tr>
                <?php
                }
                ?>
