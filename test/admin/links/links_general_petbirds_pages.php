...
function load(object) {
	if (object.options[object.selectedIndex].value == 'Select a sub-category') {
		...
		parent.home.location.href = 'pick_record.php?category=petbirds&subcategory=' + object.options[object.selectedIndex].value + '&random=1114685104' + rand(255);
    		return false;
	}
}

function quickload(place) {
	parent.home.location.href = 'pick_record.php?category=petbirds&subcategory=' + place + '&random=1114685104' + rand(255);
}

function showlinks() {
	if (subcategory == 'Pet Birds') {
...
<table border="0" cellpadding="0" cellspacing="5">
   <tr>
     <td valign="top"><font face="Verdana,Arial" size="4">&nbsp;Pet birds></font></td>
      <td>
	<form name="category">
