...
my $guestbookurl  = 'http://fatbirder.com/guest/guestbook.html';
my $guestbookreal = '/www/fatbirder/guest/guestbook.html';
my $guestlog      = '/www/fatbirder/guest/guestlog.html';
my $cgiurl        = 'http://fatbirder.com/cgi-fatbirder/guestbook.pl';
